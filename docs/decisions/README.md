...
| [007](ADR-007-context-budgeted-injection.md) | Context assembly as a budgeted injection policy — pointers over content, by lifetime; recall quality-gated (≥0.7, best-first, soft ceiling = nudge), bookmark injected as actual words | Accepted · amended by [014](ADR-014-quality-first-over-leanness.md) |
