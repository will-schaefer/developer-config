...
| [012](ADR-012-github-workflow-agent-and-conventions.md) | GitHub workflow standardized as the first nxtlvl agent composing the `github-workflow` + `review` skills; Conventional Commits, no attribution | Accepted |
