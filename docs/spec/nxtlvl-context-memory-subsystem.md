...
[ADR-012](../decisions/ADR-012-quality-first-over-leanness.md)), env-tunable. When over budget,
...
- **Read budget:** `~400 tokens` default (soft backstop, not a hard cap — densify before dropping;
  [ADR-012](../decisions/ADR-012-quality-first-over-leanness.md)); env-tunable. Cut order:
